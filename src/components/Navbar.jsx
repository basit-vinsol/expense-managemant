...
const Navbar = ({ onPurge, onLogout, onAttendance, activeTab, onHome }) => {
    ...
    <nav className={`navbar ${scrolled ? 'navbar-scrolled' : ''}`}>
      <div className="navbar-container">
        <div className="navbar-logo">
          <div className="logo-wrapper" onClick={() => onHome && onHome()} style={{ cursor: 'pointer' }}>
        ...
        <div className={`navbar-links ${mobileMenuOpen ? 'active' : ''}`}>
          <ul className="nav-menu">
            ...
            <li className="nav-item">
              <button
                className={`nav-link attendance-tab ${activeTab === 'attendance' ? 'att-active' : ''}`}
                onClick={() => { onAttendance(); closeMobileMenu(); }}
              >
